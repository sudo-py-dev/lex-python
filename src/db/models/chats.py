...
class ChatSettings(TimestampMixin, Base):
    ...
    raidActionTime: Mapped[str] = mapped_column(
        String(20), default="1h", server_default=sa_text("'1h'")
    )
    ...
    goodbyeEnabled: Mapped[bool] = mapped_column(default=False, server_default=false())
    goodbyeText: Mapped[str | None] = mapped_column(Text, nullable=True)
    cleanJoin: Mapped[bool] = mapped_column(default=False, server_default=false())
    cleanLeave: Mapped[bool] = mapped_column(default=False, server_default=false())
    cleanPinned: Mapped[bool] = mapped_column(default=False, server_default=false())
    cleanAllServices: Mapped[bool] = mapped_column(default=False, server_default=false())
    ...
    urlScannerEnabled: Mapped[bool] = mapped_column(default=False, server_default=false())
    ...
    lastAdminsUpdate: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
